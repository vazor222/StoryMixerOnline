	...
	handleOtherTraitSubmit(event) {
		...
		try {
			...
			updatePlayerInRoom(this.props.roomCodeToJoin, targetPlayerData, () => {
				...
				// other trait changed, update app state
				this.props.onStateChange("otherTrait", otherTraitText);
				console.log(this.props);
				console.log(targetPlayerData);
		...
		return (
			<div>
				...
				<div className="traitBox">
					...
					<img className="traitNameThumb" src={this.state.targetPlayerData.portrait != undefined && portraits[this.state.targetPlayerData.portrait].idle} alt={this.state.targetPlayerData.portrait != undefined && portraits[this.state.targetPlayerData.portrait].idle} /><br />
